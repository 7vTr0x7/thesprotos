    ...
    <div className="relative rounded-lg mb-3 md:py-8 py-5 bg-[#151515] px-3">
      ...
      <div className="flex justify-center text-gray-50 mb-3">
        <div className="text-center">
          ...
          <p className="mt-1 md:text-[1rem] text-sm">{match?.venue}</p>
        </div>
      </div>
      <div className="flex flex-row justify-between items-center text-gray-50 mt-3 gap-4 sm:gap-8">
        <div className="flex items-center gap-2 flex-1 justify-center sm:justify-end">
          <p className="text-sm md:text-2xl font-semibold">
            {match?.team1?.name}
          </p>
          <div className="border border-yellow-400 bg-black p-3 md:p-4 rounded-full flex justify-center items-center">
            <img
        ...
        <p className="text-lg sm:text-xl font-semibold text-center flex-shrink-0">
          {match?.time}
        </p>
        ...
        <div className="flex items-center gap-2 flex-1 justify-center sm:justify-start">
          ...
          <p className="text-sm md:text-2xl font-semibold whitespace-nowrap">
            {match?.team2?.name}
          </p>
        </div>
      </div>
